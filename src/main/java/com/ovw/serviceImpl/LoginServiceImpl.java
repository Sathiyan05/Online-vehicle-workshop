...
public class LoginServiceImpl implements LoginService {
    ...
    public ResponseEntity<?> login(String email, String password) {
        ...
        if ("SERVICE".equals(login.getRole())) {
            ServiceCenter sc = serviceRepo.findServiceCenterByEmail(email);
            if (sc == null || !"APPROVED".equals(sc.getStatus())) {
                return ResponseEntity.badRequest().body("You do not have permission to log in");
            }
        }
		...
		message.setText("Hii " +login.getEmail()+ "\nGreeting of the day...!!!\n"
